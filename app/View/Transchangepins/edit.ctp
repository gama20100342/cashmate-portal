<div class="transchangepins form">
<?php echo $this->Form->create('Transchangepin'); ?>
	<fieldset>
		<legend><?php echo __('Edit Transchangepin'); ?></legend>
	<?php
		...
		echo $this->Form->input('old_pin');
		echo $this->Form->input('new_pin');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Transchangepin.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Transchangepin.id'))); ?></li>
