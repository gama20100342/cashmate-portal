...
<?php echo $this->Form->create('Postation'); ?>
	<fieldset>
		<legend><?php echo __('Edit Postation'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Postation.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Postation.id'))); ?></li>
