...
<?php echo $this->Form->create('Withdrawal'); ?>
	...
	<?php
		...
		echo $this->Form->input('withdrawal_amount');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Withdrawal.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Withdrawal.id'))); ?></li>
