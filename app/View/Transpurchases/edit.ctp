<div class="transpurchases form">
<?php echo $this->Form->create('Transpurchase'); ?>
	<fieldset>
		<legend><?php echo __('Edit Transpurchase'); ?></legend>
	<?php
		...
		echo $this->Form->input('soa');
		echo $this->Form->input('ornumber');
	?>
	</fieldset>
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Transpurchase.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Transpurchase.id'))); ?></li>
