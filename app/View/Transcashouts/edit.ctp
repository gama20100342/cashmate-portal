<div class="transcashouts form">
<?php echo $this->Form->create('Transcashout'); ?>
	<fieldset>
		<legend><?php echo __('Edit Transcashout'); ?></legend>
	<?php
		...
		echo $this->Form->input('cashout_amount');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Transcashout.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Transcashout.id'))); ?></li>
