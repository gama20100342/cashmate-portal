<div class="transloadcashes form">
<?php echo $this->Form->create('Transloadcash'); ?>
	<fieldset>
		<legend><?php echo __('Edit Transloadcash'); ?></legend>
	<?php
		...
		echo $this->Form->input('load_amount');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Transloadcash.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Transloadcash.id'))); ?></li>
