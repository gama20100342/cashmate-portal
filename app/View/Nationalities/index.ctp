<div class="nationalities index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $nationality['Nationality']['id']), array(), __('Are you sure you want to delete # %s?', $nationality['Nationality']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
